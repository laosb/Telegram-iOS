            ...
            case let .postbox(postbox):
                ...
                |> mapToSignal { localizationSettings, proxySettings -> Signal<AccountResult, NoError> in
                    ...
                    |> mapToSignal { (accountState, localizationSettings, proxySettings, networkSettings, appConfig) -> Signal<AccountResult, NoError> in
                        ...
                        return initializedNetwork(accountId: id, arguments: networkArguments, supplementary: supplementary, datacenterId: CustomDCConfig.initialDatacenterId, keychain: keychain, basePath: path, testingEnvironment: beginWithTestingEnvironment, languageCode: localizationSettings?.primaryComponent.languageCode, proxySettings: proxySettings, networkSettings: networkSettings, phoneNumber: nil, useRequestTimeoutTimers: useRequestTimeoutTimers, appConfiguration: appConfig)
                        |> map { network -> AccountResult in
